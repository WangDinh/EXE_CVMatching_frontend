const CommonFooter: React.FC = () => {
  return (
    <footer className='bg-[#e5e5e5] w-full px-[100px] text-gray-500'>
      <div className='container mx-auto max-w-5xl'>
        <div className='grid grid-cols-12 pb-10 gap-10 '>
          <div className='col-span-12 mt-10 md:col-span-6 lg:col-span-3'>
            <a href='#' className='flex items-center '>
              <img className='w-24 h-auto mr-4' src='/FSA_logo.png' alt='Matching to your dream job' />
              <span>Matching to your dream job</span>
            </a>
            <p className='mt-6'>
              We are committed to delivering high-quality software solutions. For support, please contact us at
              FA.DN@fpt.com.
            </p>
          </div>
          <div className='col-span-12 mt-10 md:col-span-6 lg:col-span-3'>
            <h6 className='mb-6 font-bold text-lg text-black'>Socials</h6>
            <p>FA.DN@fpt.com</p>
            <ul className='flex items-center gap-5 mt-4 lg:mt-6'>
              <li>
                <a href='#'>
          ...
          <div className='col-span-12 mt-10 md:col-span-6 lg:col-span-3'>
            <h6 className='mb-6 font-bold text-lg text-black'>Quick Links</h6>
            <ul>
              <li>
          ...
          <div className='col-span-12 mt-10 md:col-span-6 lg:col-span-3'>
            <h6 className='mb-6 font-bold text-lg text-black'>Location & Contact</h6>
